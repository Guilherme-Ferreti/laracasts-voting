<x-app-layout>
    <div class="filters flex space-x-6">
        ...
        <div class="w-2/3 relative">
            <input type="search" name="search" placeholder="Find an idea" class="w-full rounded-xl bg-white border-none placeholder-gray-900 px-4 py-2 pl-8">
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card trasition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            <div class="border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl trasition duration-150 ease-in px-4 py-3">Vote</button>
                </div>
            </div>
            <div class="flex px-2 py-6">
                ...
                <div class="mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi dolore autem provident a saepe itaque maxime dolores nam odio, repellendus ipsum hic inventore, amet facilis reiciendis eos commodi magni aut. Vero odio ducimus commodi quo unde doloribus rem numquam. Esse velit, perspiciatis veritatis voluptatem necessitatibus recusandae asperiores, quibusdam sapiente, ipsam similique quae numquam excepturi. Quo nobis perferendis earum voluptates doloremque quia commodi quidem incidunt officiis, beatae illo necessitatibus molestias non sed libero iusto eius obcaecati inventore ad unde est, itaque minus. Et incidunt, iusto exercitationem sapiente aliquam distinctio quia, cupiditate aut molestias ea reiciendis sint nemo quidem fugiat eaque atque.
                    </div>
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="bg-gray-200 text-xxs font-bold uppercase rounded-full leading-none text-center w-28 h-7 py-2 px-4">Open</div>
                            <button class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 trasition duration-150 ease-in py-2 px-3">
                                ...
                                <ul class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 ml-8">
                                    <li><a href="#" class="hover:bg-gray-100 block trasition duration-150 ease-in px-5 py-3">Mark as Span</a></li>
