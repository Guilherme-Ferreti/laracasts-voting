            ...
            <div class="space-y-2">
                <div>
                    <label class="inline-flex items-center">
                        ...
                        <span class="ml-2">{{ __('messages.ideas.Open') }}</span>
                    </label>
                </div>
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" class="bg-gray-200 text-purple border-none" name="status" value="2">
                        <span class="ml-2">{{ __('messages.ideas.Considering') }}</span>
                    </label>
                </div>
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" class="bg-gray-200 text-yellow border-none" name="status" value="3">
                        <span class="ml-2">{{ __('messages.ideas.In Progress') }}</span>
                    </label>
                </div>
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" class="bg-gray-200 text-green border-none" name="status" value="4">
                        <span class="ml-2">{{ __('messages.ideas.Implemented') }}</span>
                    </label>
                </div>
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" type="radio" class="bg-gray-200 text-red border-none" name="status" value="5">
                        <span class="ml-2">{{ __('messages.ideas.Closed') }}</span>
                    </label>
                </div>
            </div>

            <div>
                <textarea wire:model="comment" name="update_comment" id="update_comments" cols="30" rows="3" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" placeholder="{{ __('Add an update comment (optional)') }}"></textarea>
            </div>
