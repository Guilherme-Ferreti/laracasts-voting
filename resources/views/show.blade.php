        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quas, rerum aspernatur odit voluptate temporibus porro dolorum! Consequuntur porro doloribus maxime numquam corporis quam iure aspernatur laboriosam aliquid! Soluta, sed id et omnis quidem autem eos quod quia laboriosam voluptas placeat ab pariatur veniam aspernatur neque fugit suscipit minus dicta unde, cum porro eligendi! Temporibus deleniti quibusdam sequi veniam, iusto ipsam reprehenderit ratione quam, odit modi expedita corporis, quae provident similique sapiente minus dolorum accusamus voluptatum!
                </div>
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div class="hidden flex items-center space-x-2">
                        ...
                        <button class="relative bg-gray-100 hover:bg-gray-200 rounded-full border h-7 trasition duration-150 ease-in py-2 px-3">
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                ...
                <div class="absolute z-10 w-104 text-left font-semibol text-sm bg-white shadow-dialog rounded-xl mt-2">
            ...
            <div class="relative">
                ...
                <div class="absolute z-20 w-76 text-left font-semibol text-sm bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" method="post" class="space-y-4 px-4 py-6 ">
                        <div class="space-y-2">
                            <div>
    ...
    <div class="comments-container relative space-y-6 pt-4 ml-22 my-8 mt-1">
        <div class="comment-container relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                ...
                <div class="w-full mx-4">
                    <div class="text-gray-600 mt-3">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. In ratione, aperiam nobis ullam quas omnis aliquid expedita fugiat doloribus quisquam rem harum itaque qui ab nam voluptas recusandae esse enim!
                    </div>
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                            <div class="font-bold text-gray-900">John Doe</div>
