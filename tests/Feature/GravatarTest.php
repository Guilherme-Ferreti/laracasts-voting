...
class GravatarTest extends TestCase
{
    ...
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_character_a()
    {
        ...
        $this->assertEquals(
            'https://www.gravatar.com/avatar/'.md5($user->email).'?size=200&d=https://s3.amazonaws.com/laracasts/images/forum/avatars/default-avatar-1.png',
            $gravatarUrl
        );
    ...
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_character_z()
    {
        ...
        $this->assertEquals(
            'https://www.gravatar.com/avatar/'.md5($user->email).'?size=200&d=https://s3.amazonaws.com/laracasts/images/forum/avatars/default-avatar-26.png',
            $gravatarUrl
        );
    ...
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_character_0()
    {
        ...
        $this->assertEquals(
            'https://www.gravatar.com/avatar/'.md5($user->email).'?size=200&d=https://s3.amazonaws.com/laracasts/images/forum/avatars/default-avatar-27.png',
            $gravatarUrl
        );
    ...
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_character_9()
    {
        ...
        $this->assertEquals(
            'https://www.gravatar.com/avatar/'.md5($user->email).'?size=200&d=https://s3.amazonaws.com/laracasts/images/forum/avatars/default-avatar-36.png',
            $gravatarUrl
        );
