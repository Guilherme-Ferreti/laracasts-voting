...
class NotificationsTest extends TestCase
{
    ...
    /** @test */
    public function notifications_livewire_component_renders_when_user_logged_in()
    {
    ...
    /** @test */
    public function notifications_livewire_component_does_not_render_when_user_not_logged_in()
    {
